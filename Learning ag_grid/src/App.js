...
function App() {
  ...
  const columnDefs = [
...

    {
      ...
      tooltipField: "make",
      cellClass: (e) =>
        e.value < 40000 ? "priceLessThan40000" : "priceGreaterThan40000",
    },
    {
      field: "action",
  ...
  return (
    <div id="background">
      ...
      <div id="btns">
        <button id="exportBtn" onClick={() => handleExportBtns()}>
          Export All
        </button>
        <button
          id="exportSelectedRowsBtn"
          onClick={() => handleExportBtns("select")}
        >
          Export Selected Rows
        </button>
        <button id="hideBtn" onClick={hideColumn}>
          Hide price column
        </button>
